            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-10 py-6 relative z-10">
                ...
                >
                    <h3 className="text-2xl font-britanica text-center mb-8 text-white">
                        Building Kosovo&rsquo;s Esports Future
                    </h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <p className="text-gray-300 font-britanica-regular">
                                We&rsquo;ve established training academies across Kosovo to identify and nurture young talent.
                                Our curriculum focuses not just on gaming skills but also on mental resilience, teamwork,
                                and strategic thinking &mdash; qualities that benefit players both in-game and in life.
                            </p>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 font-britanica-regular">
                                ...
                                workshops. These initiatives help grow Kosovo&rsquo;s esports culture while promoting responsible
