        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8 ">
            <div className="mx-auto flex flex-col lg:flex-row gap-8">
                                ...
                                <article key={post.id} className="group relative overflow-hidden rounded-2xl transition-all duration-300 ">
                                    ...
                                    <div className="relative z-10 p-5 bg-[#050219] backdrop-blur-sm rounded-b-2xl">
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-gray-800">
                                            <a href="#" className="text-white hover:text-[#4e5bfc] text-sm font-britanica-regular flex items-center transition-colors">
                                                Read more
                                    ...
                                    <div className="flex flex-col md:flex-row justify-center items-center">
                                        ...
                                        <div className="relative md:w-1/3 lg:h-64 2xl:h-80 overflow-hidden rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none">
                                            ...
                                            <div className="absolute top-4 left-4 z-10 flex items-center">
                                                <span className={`px-3 py-1 text-xs font-bold rounded-full ${post.category === 'CS2' ? 'bg-blue-900/80 text-blue-300' : post.category === 'Dota 2' ? 'bg-purple-900/80 text-purple-300' : 'bg-pink-900/80 text-pink-300'}`}>
                                                    {post.category}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative z-10 p-5 md:w-2/3">
                                            ...
                                            <div className="flex items-center justify-between pt-3 border-t border-gray-800">
                                                ...
                                                <a href="#" className="text-blue-400 hover:text-blue-300 text-sm font-medium flex items-center transition-colors">
                                                    Read More
                                                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                                    </svg>
                ...
                <div className="lg:w-[25%]">
                    <div className="bg-[#050219] backdrop-blur-sm rounded-2xl  p-6 top-6">
                    ...
                    <div className="bg-[#050219] backdrop-blur-sm rounded-2xl border border-gray-800 p-6 mt-6">
                        <h3 className="text-xl font-bold text-white mb-6 pb-4 border-b border-gray-800 flex items-center">
